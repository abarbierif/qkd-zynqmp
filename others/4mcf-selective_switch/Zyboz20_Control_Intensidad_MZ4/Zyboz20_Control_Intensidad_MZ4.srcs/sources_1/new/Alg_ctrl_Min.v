...
reg EnControl1=0;
Ctrl_busquedaMin c1(.sysclk(sysclk),.sync(sync),.EnControl(EnControl1),.I_Actual(I_Actual),
.pasos(pasos),.SControl(SControl1),.CicloOk(CicloOk1));  

reg EnControl2=0;
Ctrl_busquedaMin c2(.sysclk(sysclk),.sync(sync),.EnControl(EnControl2),.I_Actual(I_Actual),
.pasos(pasos),.SControl(SControl2),.CicloOk(CicloOk2));  

reg EnControl3=0;
Ctrl_busquedaMin c3(.sysclk(sysclk),.sync(sync),.EnControl(EnControl3),.I_Actual(I_Actual),
